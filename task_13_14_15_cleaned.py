...
def task_13_covariance_from_historical_betas(
    ...
    """
    print(f"Задача 13: Расчет ковариационной матрицы на основе исторических β...")
    print(f"Рыночный индекс: {market_ticker}")
    print(f"Учет остаточных дисперсий: {include_residuals}")
...
def task_14_efficient_frontier_from_betas(
    ...
    """
    print(f"\nЗадача 14: Построение эффективной границы на основе {method_name}...")
...
def main():
    ...
    """
    print("=" * 60)
    print("Задачи 13-15: Оценка на основе исторических β")
    print("=" * 60)
    print()
    ...
    print(f"Акции: {list(returns.columns)}")
    print()
